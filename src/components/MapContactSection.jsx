      ...
      <div className="section-container scroll-animate">
        ...
        <div className="details-col scroll-animate">
          <h2 className="resort-title">
            {!loading ? info?.resort_name || "Alyna's Resort" : ""}
          </h2>
          ...
          <div className="contact-info-list">
            ...
            <div className="info-item">
              ...
              <div className="text-box">
                <h4>Email Support</h4>
                <p className="italicS">
                  {!loading ? info?.email || "alynasresort@gmail.com" : ""}
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="framed-map-box">
            ...
            <div className="map-overlay-card">
              ...
              {!loading && (
                <a
                  href={
                    info?.map_url || "https://maps.app.goo.gl/fYQViFEFsVq5GEmb9"
                  }
                  target="_blank"
